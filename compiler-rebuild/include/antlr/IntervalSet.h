...
public:
  ...
  template <typename T1, typename... T_NEXT> IntervalSet(int, T1 t1, T_NEXT &&... next) : IntervalSet() {
  ...
  template <typename T1, typename... T_NEXT> void addItems(T1 t1, T_NEXT &&... next) {
    add(t1);
