...
{
    // define basic blocks
    auto while_block = BasicBlock::Create(context, "while_block" + std::to_string(bb_count++), current_function);
    auto while_body  = BasicBlock::Create(context, "while_body" + std::to_string(bb_count++), current_function);
    auto while_next  = BasicBlock::Create(context, "while_next" + std::to_string(bb_count++), current_function);
