...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @putch(i32) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i8, align 1
  store i32 %0, i32* %2, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @putarray(i32, i32*) #0 {
  %3 = alloca i32, align 4
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %6)
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @putf(i8*, ...) #0 {
  %2 = alloca i8*, align 8
...
16:                                               ; preds = %1
  ...
  %18 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %17, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0))
  br label %38
...
19:                                               ; preds = %1
  ...
  %28 = call i32 @vsprintf(i8* %25, i8* %26, %struct.__va_list_tag* %27) #5
  ...
  %37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0), i8* %36)
  br label %38
